...
<body class="respond" leftmargin="0" topmargin="0" marginwidth="0"
	marginheight="0">
	<!-- pre-header -->
		...
		<tr>
			<td>
				<div
					...
					Pre-header for the newsletter template</div>
			</td>
		</tr>
	</table>
	<!-- pre-header end -->
		...
		<tr>
			<td align="center">
				<table border="0" align="center" width="590" cellpadding="0"
					cellspacing="0" class="container590">
								...
								<tr>
									...
									<td align="center"><a href=""
										style="display: block; border-style: none !important; border: 0 !important;">
											<img border="0" style="display: block; width: 100px;"
											src="images/leggo_logo.png" alt="" />
									</a></td>
								</tr>
							</table>
						</td>
			...
			<td align="center">
				<table border="0" align="center" width="590" cellpadding="0"
					...
					<tr>
						...
						<td align="center" class="section-img"><a href=""
							style="border-style: none !important; display: block; border: 0 !important;"></a></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="center"
							...
							<div style="line-height: 35px">
								임시 비밀번호는 <span style="color: #649ef5;">5caad2</span> 입니다.
							</div> <br>
						</td>
					</tr>
					...
					<tr>
						<td align="center">
							<table border="0" width="40" align="center" cellpadding="0"
								...
								<tr>
									<td align="center"
										...
										<div style="width: 500px; line-height: 24px;">
											로그인을 완료하신 뒤 비밀번호를 변경해주세요.<br> 비밀번호 변경 전까지 사이트 기능을 이용하실 수
											없습니다.
										</div>
									</td>
								</tr>
					...
					<tr>
						<td align="center">
							<table border="0" align="center" width="160" cellpadding="0"
								cellspacing="0" bgcolor="2A79EF" style="border-radius: 5px;">
								...
								<tr>
									<td align="center"
										...
										<div style="line-height: 26px;">
											<a href="http://localhost:8090/PrjApp/Login.jsp"
												style="color: #ffffff; text-decoration: none;">로그인하러 가기</a>
										</div>
									</td>
								</tr>
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0"
		...
		<tr>
			<td height="60"
				style="border-top: 1px solid #e0e0e0; font-size: 60px; line-height: 60px;">&nbsp;</td>
		</tr>

		<tr>
			<td align="center">
				<table border="0" align="center" width="590" cellpadding="0"
					cellspacing="0" class="container590 bg_color">
								...
								<tr>
									...
									<td align="left"><a href=""
										style="display: block; border-style: none !important; border: 0 !important;"><img
											border="0" style="display: block; width: 80px;"
											src="images/leggo_logo.png" alt="" /></a></td>
								</tr>
									...
									<td align="left"
										...
										<div
											...
											Email us: <br /> <a href="mailto:"
												style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">2021leggo@gmail.com</a>
