	...
	<div class="container">
		<div class="main-body">
			...
			<table class="filter">
				<tr>
					<td>
						<button style="background-color: Silver; width: 100px; height: 40px; font-size: 13px; padding: 0.0em 1.5em;">정렬▼</button>
						<!-- <button style="background-color: Silver; width: 70px; height: 35px; font-size: 11px; padding: 0.0em 1.5em;">장소▼</button>
						<button style="background-color: Silver; width: 70px; height: 35px; font-size: 11px; padding: 0.0em 1.5em;">도시▼</button> -->
					</td>
				</tr>
			</table>
			<table>
