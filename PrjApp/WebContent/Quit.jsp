			...
			<div class="card mb-3">
				<div class="card-body">
					...
					<div class="album py-5 bg-light">
						...
						<div class="container row justify-content-center">
							<div class="quit_box">
								<h4 style="clear: right; font-weight: bold;">탈퇴 사유 선택 <span style="font-size: 17px;">(복수선택 가능)</span></h4>
							</div>
							<span class="border border-secondary"
								style="padding: 20px; width: 650px; background-color: white; border-radius: 10px;">
								 <label style="font-size: 17px;">
								 	<input type="checkbox" id="agreecheck" style="width: 15px; height: 15px;" value="agreed">&nbsp;&nbsp;
								 	이용빈도 낮음
								 </label><br>
								 <label style="font-size: 17px;">
								 	<input type="checkbox" id="agreecheck" style="width: 15px; height: 15px;" value="agreed">&nbsp;&nbsp;
