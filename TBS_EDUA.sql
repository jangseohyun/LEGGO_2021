...
-- 5. 회원가입 설문조사 답변 상태(MEMBER_ANSWER_STATUS)
...
CREATE TABLE OPEN
( OPEN_CD   NUMBER(1)
, OPEN_ST   VARCHAR2(6) CONSTRAINT OPEN_OPEN_ST_NN NOT NULL
, CONSTRAINT OPEN_OPEN_CD_PK PRIMARY KEY(OPEN_CD)
);
--==>> Table OPEN이(가) 생성되었습니다.

-- 9. 신고 처리 상태(REPORT_STATUS)
...
-- 14. 탈퇴회원 정보 임시보관(QUIT_MEMBER_DATA)
...
-- 33. 사진 게시글 댓글(PHOTO_POST_COMMENT)
...
-- 34.사진 게시글 스크랩(PHOTO_POST_SCRAP)
...
-- 35. 사진 게시글 신고(PHOTO_POST_REPORT)
