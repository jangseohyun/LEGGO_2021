...
String cp = request.getContextPath();
      ...
      out.write("\t\t\t\t\t<h4 style=\"display: inline-block; font-weight: bold; padding: 5px;\">회원\r\n");
      out.write("\t\t\t\t\t\t탈퇴</h4>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<h4 style=\"clear: right; font-weight: bold;\">탈퇴 전 안내 사항</h4>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<h5 style=\"font-weight: bold;\">회원 탈퇴 시 처리 내용</h5>\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>소비자보호에 관한 법률 제6조에 의거,계약 또는 청약철회 등에 관한 기록은 5년, 소비자의 불만\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t또는 분쟁처리에 관한 기록은 3년 동안 보관됩니다. 동 개인정보는 법률에 의한 보유 목적 외에 다른 목적으로는\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t이용되지 않습니다.</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t<h5 style=\"font-weight: bold;\">회원 탈퇴 시 게시물 관리</h5>\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>회원 탈퇴 후 LEGGO 서비스에 입력한 게시물 및 댓글은 삭제되지 않으며, 회원정보 삭제로 인해\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t작성자 본인을 확인할 수 없으므로 게시물 편집 및 삭제 처리가 원천적으로 불가능 합니다.</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>게시물 삭제를 원하시는 경우에는 먼저 해당 게시물을 삭제 하신 후 탈퇴를 신청하시기 바랍니다.</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t<h5 style=\"font-weight: bold;\">회원 탈퇴 후 재가입 규정</h5>\r\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>회원 탈퇴 시 개인정보보호법에 의거하여 6개월 간 회원 정보를 보관한 후 삭제합니다. 따라서\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t6개월 이내에는 이전 이메일로 재가입이 불가능한 점 유의 바랍니다.</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tvalue=\"agreed\">&nbsp;&nbsp; 상기 내용을 확인하였으며 이에 동의합니다. <span\r\n");
      out.write("\t\t\t\t\t\t\t\tstyle=\"color: red;\">(필수)</span></label>\r\n");
      out.write("\t\t\t\t\t\t</div><br><br><br>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"container row justify-content-center\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"quit_box\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<h4 style=\"clear: right; font-weight: bold;\">탈퇴 사유 선택 <span style=\"font-size: 17px;\">(복수선택 가능)</span></h4>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"border border-secondary\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstyle=\"padding: 20px; width: 650px; background-color: white; border-radius: 10px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 20%; font-family: 'Noto Sans KR', sans-serif;\">취소하기</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-secondary center submit\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"width: 20%; font-family: 'Noto Sans KR', sans-serif;\">탈퇴하기</button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
