...
<body>
	<div class="container">
		...
		<table class="table">
			...
			<tr>
				<td style="text-align: left;">${post.mem_nnm }의 사진 게시물</td>
				<td style="text-align: center;">${post.mem_nnm }</td>
				<td style="text-align: center;">${post.dt }</td>
	...
	<div class="container">
		...
		<div id="tab-1" class="tab-content current">
			<table style="width: 100%; text-align: center;">
				...
				<tr onClick="window.open('memberreport.action?ppr_cd=${rpt.ppr_cd}', '', 'width=570, height=260'); return false;">
					<td>${i }</td>
